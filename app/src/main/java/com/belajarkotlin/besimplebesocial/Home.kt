...
class Home : AppCompatActivity(), Communicator {
    ...
    override fun onClickWhatsapp() {
        try {
            ...
            Toast.makeText(this, "Anda akan diarahkan ke WhatsApp Customer Service kami", Toast.LENGTH_LONG).show()
    ...
    fun getData() {
        ...
        navController.setGraph(R.navigation.my_nav, Bundle().apply {
            putString("names", "My name is xx")
            putString("email", "fauzan@gmail.com")
